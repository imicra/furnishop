...
get_header( 'shop' );
?>
<aside class="toolbar container-fluid">
	<div class="row theme-wrapper">
		<div class="toolbar-content col-12">
			<a href="#" class="shop-filters-link">Фильтр</a>
			<?php
			/**
			 * Hook: furnishop_woocommerce_top_sidebar.
			 * 
			 * @hooked woocommerce_result_count - 20
			 * @hooked woocommerce_catalog_ordering - 30
			 */
			do_action( 'furnishop_woocommerce_sidebar_top' );
			?>
		</div>
		<div class="toolbar-hidden col-12">
			<?php
			/**
