...
<form class="variations_form cart" action="<?php echo esc_url( get_permalink() ); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations="<?php echo htmlspecialchars( wp_json_encode( $available_variations ) ) ?>">
	...
	<p class="variations-title"><?php _e( 'Выберите свой вариант:', 'woocommerce' ); ?></p>
					...
					<tr>
						...
						<td class="value">
							<?php
								...
								wc_dropdown_variation_attribute_options( array( 'options' => $options, 'attribute' => $attribute_name, 'product' => $product, 'selected' => $selected, 'show_option_none' => __( 'Выбрать вариант', 'woocommerce' ) ) );
